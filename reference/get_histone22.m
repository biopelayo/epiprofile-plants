function [cur_rts,cur_intens,cur_mono_isointens] = get_histone22(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,unitdiff,Mods,His,hno,special)
%%
...
[h_rts,h_intens] = get_histone11(MS1_index,MS1_peaks,ptol,unitdiff,His,hno);
if 0==h_intens(1)
    return;
end;
