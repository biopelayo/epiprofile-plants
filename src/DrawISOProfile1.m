...
for i=1:length(raw_names)
    ...
    if 1==special.nsource || 2==special.nsource
        ...
        if '1'==special.soutput(2)
            ...
            HH2A_AT09_can_36_42(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special);
            ...
            HH2B_AT08_shared_80_86(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special);
