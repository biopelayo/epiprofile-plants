...
%% HH2B_01u_104_145 — Unmod-only H2B diagnostic peptides (CR)
%
%  TIER: T2 (EpiProfile-PLANTS, Chlamydomonas reinhardtii)
%  HISTONE: H2B (conserved core peptide)
%  REGION: Core domain
%
%  PEPTIDES (Arg-C-like, propionylated):
%    1. QAVKKPTVTSR — 4/4 CR H2B variants (all full-length, Arg-C product)
%    2. EIQTAVR     — universal H2B, all eukaryotes
%    3. LVLPGELAKHAVSEGTKAVTKFTSG — conserved 4/4 CR C-term (G ending)
%
%  NOTES:
%    - Sequences confirmed from SwissProt: P50565, P54345, P54346, P54347
%    - CR has PTVTSR (Val) vs AT PTITSR (Ile) — 14 Da diff
%    - CR C-term ends FTSG (not FTSS as AT)
...
His.pep_seq = 'unmod';
His.mod_short = {'QAVKKPTVTSR';
    'EIQTAVR';
    'LVLPGELAKHAVSEGTKAVTKFTSG'};
