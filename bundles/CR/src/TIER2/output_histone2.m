...
% Fix D-CRIT-1 (Tribunal de Codigo 2026-05-24): NaN si senal < umbral
INTENS_THRESHOLD = 1e3;
...
npep = npep1+npep2;
% Fix D-CRIT-1 (Tribunal de Codigo 2026-05-24): NaN si senal combinada < umbral
INTENS_THRESHOLD = 1e3;
...
if total_intens < INTENS_THRESHOLD
    ...
    for ino=1:npep
        auc1(ino,3) = auc1(ino,2)/total_intens;
    end;
end;