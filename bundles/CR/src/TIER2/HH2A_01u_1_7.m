...
%% HH2A_01u_1_7 — Unmod-only H2A diagnostic peptides (CR)
%
%  TIER: T2 (EpiProfile-PLANTS, Chlamydomonas reinhardtii)
%  HISTONE: H2A (variant-diagnostic short peptides)
%  REGION: Core domain (conserved across H2A subtypes)
%
%  PEPTIDES: 8 diagnostic peptides (DNKKSR, DNKKTR, DNKKNR, HLLLAIR,
%            HLQLAIR, HLCLAIR, HIQLAVR, HVLLAVR)
%  NOTES:
%    - Unmod search only. K residues propionylated.
%    - rt_ref = 0 (no prior experimental data for CR).
