...
%% DrawISOProfile1 — Main runner for histone_normal mode (CR bundle)
%
%  TIER: T2 (modified from upstream EpiProfile 2.0 basic)
%  ORIGIN: Forked from AT bundle for EpiProfile_PLANTS CR bundle.
%          CR-specific: H3_14_27_40 uses KTPATGGVKKPHR.
