function HH2B_01u_104_145(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%% HH2B_01u_104_145 — Unmod-only H2B diagnostic peptides (AT)
%
%  TIER: T2 (EpiProfile-PLANTS, Arabidopsis thaliana)
%  HISTONE: H2B (canonical variants H2B.1–H2B.11, excl. divergent H2B.2)
%  REGION: Core-to-C-terminal (positions 104–145 in H2B.10/At5g22880)
%
%  PEPTIDES (Arg-C-like, propionylated):
%    1. QAVKKPTITSR    — 8/10 canonical long variants (dominant Arg-C product)
%    2. YNKKPTITSR     — 2/10 short variants (H2B.5, H2B.8)
%    3. EIQTAVR        — conserved 10/10 variants, universal H2B
%    4. LVLPGELAKHAVSEGTKAVTKFTSS — conserved 8/10 (canonical C-term)
%    5. LVLPGELAKHAVSEGTKAVTKFTS  — H2B.4 diagnostic (missing final S)
%    6. LVLPGELSKHAVSEGTKAVTKFTSS — H2B.8 diagnostic (S vs A at pos 8)
%
%  NOTES:
%    - Unmod search only (no PTM enumeration). K residues propionylated.
%    - Positions are 0-based in H2B.10 (At5g22880) reference.
%    - rt_ref values are provisional (0 = unknown, to be calibrated).

% check
out_filename = 'HH2B_01u_104_145';
...
His.pep_seq = 'unmod';
His.mod_short = {'QAVKKPTITSR';
    'YNKKPTITSR';
    'EIQTAVR';
    'LVLPGELAKHAVSEGTKAVTKFTSS';
    'LVLPGELAKHAVSEGTKAVTKFTS';
    'LVLPGELSKHAVSEGTKAVTKFTSS'};
His.mod_type = {'0,pr;4,pr;5,pr;';
    '0,pr;3,pr;4,pr;';
    '0,pr;';
    '0,pr;9,pr;17,pr;21,pr;';
    '0,pr;9,pr;17,pr;21,pr;';
    '0,pr;9,pr;17,pr;21,pr;'};
...
% Search all H2B unmod peptides
% 104-113 YNKKPTITSR      (core, 10/10 AT H2B variants)
% 114-120 EIQTAVR          (core, 10/10, universal H2B)
% 121-145 LVLPGELAKHAVSEGTKAVTKFTSS (8/10 canonical C-term)
% 121-144 LVLPGELAKHAVSEGTKAVTKFTS  (H2B.4 diagnostic)
% 114-138 LVLPGELSKHAVSEGTKAVTKFTSS (H2B.8 diagnostic)
for hno=1:npep
