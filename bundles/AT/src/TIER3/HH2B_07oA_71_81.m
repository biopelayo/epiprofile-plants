function HH2B_07oA_71_81(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
% no internal K — C-terminal K10 only (trypsin cleavage site, after SS)
