function HH2A_01oA1_7_14(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
% no internal K — C-terminal K7 only (trypsin cleavage site)
