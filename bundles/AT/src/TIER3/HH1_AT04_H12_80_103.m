function HH1_AT04_H12_80_103(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
His.pep_seq = 'TGSSQYAIQKFIEEKHKSLPPTFR';
His.mod_short = {'unmod';
    'K10me1';
    'K10me2';
    'K10me3';
    ...
    'K10me1K15ac';
    'K10acK15ac'};
His.mod_type = {'0,pr;10,pr;15,pr;17,pr;';
    '0,pr;10,me1;15,pr;17,pr;';
    '0,pr;10,me2;15,pr;17,pr;';
    '0,pr;10,me3;15,pr;17,pr;';
    '0,pr;10,ac;15,pr;17,pr;';
    '0,pr;10,pr;15,ac;17,pr;';
    '0,pr;10,pr;15,pr;17,ac;';
    '0,pr;10,me1;15,ac;17,pr;';
    '0,pr;10,ac;15,ac;17,pr;'};
...
if 0==His.rt_ref(hno-1)
    His.rt_ref(hno) = 0;
elseif old_t~= His.rt_ref(hno-2);
    d = His.rt_ref(hno-2) - old_t;
    His.rt_ref(hno) = His.rt_ref(hno) + d;
end;
...
if 0==His.rt_ref(6)
    His.rt_ref(hno) = 0;
elseif old_t~= His.rt_ref(6);
    d = His.rt_ref(6) - old_t;
    His.rt_ref(hno) = His.rt_ref(hno) + d;
end;
...
[rts9,top1_rt9] = get_rts22(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,unitdiff,His,hno,nsplit,t1,t2,nhmass);
