function HH1_15oA1_151_159(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%

% check
out_filename = 'HH1_15oA1_151_159';
...
His.pep_seq = 'KPATVAVTK';
His.mod_short = {'unmod'
    'K151ac'};
His.mod_type = {'0,pr;0,pr;'
    '0,pr;0,ac;'};
