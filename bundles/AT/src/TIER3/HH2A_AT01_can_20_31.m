function HH2A_AT01_can_20_31(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
% H2A canonical+X peptide SSKAGLQFPVGR (residues 20-31)
% K22 modifications: unmod, me1, me2, me3, ac
% Analogous to H3_01_3_8 structure
...
His.rt_ref = [32.73% unmod RT from 0_ref_info.mat
    35% K22me1 (estimate: me1 eluye despues del unmod)
    25% K22me2 (estimate: me2 eluye antes)
    25% K22me3 (estimate: me3 coeluye con me2)
    31];% K22ac (estimate: entre me2 y unmod)
...
% K22me1 (eluye despues del unmod, como K4me1 en H3)
hno = 2;
