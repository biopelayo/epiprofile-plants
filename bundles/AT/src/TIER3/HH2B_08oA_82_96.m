function HH2B_08oA_82_96(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
% no internal K — C-terminal K14 only (trypsin cleavage site)
