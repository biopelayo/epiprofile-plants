function HH2A_04oAW_54_82(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%

% check
out_filename = 'HH2A_04oAW_54_82';
...
His.pep_seq = 'YGSGAPVYLAAVLEYLAAEVLELAGNAAR';
His.mod_short = {'unmod'};
His.mod_type = {'0,pr;'};
