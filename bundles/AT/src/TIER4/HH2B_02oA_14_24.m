function HH2B_02oA_14_24(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%
...
% no internal K — C-terminal K10 only (trypsin cleavage site)
