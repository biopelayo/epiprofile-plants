function HH1_01oA1_1_29(MS1_index,MS1_peaks,MS2_index,MS2_peaks,ptol,cur_outpath,special)
%%

% check
out_filename = 'HH1_01oA1_1_29';
...
His.pep_seq = 'MSEVEIENAATIEGNTAADAPVTDAAVEK';
His.mod_short = {'unmod'};
His.mod_type = {'0,pr;'};
